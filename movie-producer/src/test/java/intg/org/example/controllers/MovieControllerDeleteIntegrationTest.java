...
@EmbeddedKafka(topics = {"movies"}, partitions = 1,ports = 9092)
@TestPropertySource(properties = {"spring.kafka.producer.bootstrap-servers=${spring.embedded.kafka.brokers}",
        "spring.kafka.admin.properties.bootstrap.servers=${spring.embedded.kafka.brokers}"})
public class MovieControllerDeleteIntegrationTest {
    ...
    /**
     * Integration test for the DELETE endpoint to delete a Movie.
     * Sends a DELETE request, verifies the HTTP response, and checks the Kafka topic for the deleted movie.
     ...
     */
    @Test
    public void deleteMovie() throws JsonProcessingException {

        Movie movie = org.example.util.TestUtil.movieDeleteRecord();
        ...
        var responseEntity = restTemplate.exchange("/delete/movie", HttpMethod.DELETE, request, Movie.class);
